"""
Twitter integration - Twitter client and posting functionality
"""
...
class TwitterPoster:
    ...
    async def twitter_poster_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Twitter poster enable/disable command"""
        # This will be called from handlers with bot reference
        if context.args and context.args[0].lower() in ['on', 'enable', 'start']:
            await update.message.reply_text(
                "✅ Twitter poster enabled! Second channel posts will be auto-posted to Twitter."
            )
