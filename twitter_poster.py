...
class TwitterPoster:
    ...
    def enable_poster(self, enabled=True):
        """Enable or disable Twitter poster"""
        self.twitter_poster_enabled = enabled
        status = "enabled" if enabled else "disabled"
        logger.info(f"Twitter poster {status}")

    async def shutdown(self):
        """Cleanup resources"""
        self.twitter_client = None
        logger.info("Twitter poster shutdown complete")
